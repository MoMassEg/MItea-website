  ...
  return (
    <div className="fixed right-0 top-[45%] -translate-y-1/2 z-35 flex items-center">
      <button
        ...
        className="group relative flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 bg-gradient-to-l from-accent-amber via-amber-400 to-amber-500 hover:from-accent-gold hover:to-amber-400 text-[#120602] rounded-l-2xl shadow-xl border-l-2 border-y border-amber-200/90 cursor-pointer transition-transform hover:scale-105 active:scale-95"
        aria-label="Subscribe for 15% Off"
        title="Email Subscription - Claim 15% Off"
      >
        <Mail className="w-4 h-4 text-[#120602] transition-transform group-hover:scale-110" />
        
        {/* Tiny 15% discount badge */}
