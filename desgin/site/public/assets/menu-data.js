/**
 * MiTea - Premium Bubble Tea & Asian Dessert Ordering Platform
 * Location: 7724 Olson Mem Hwy, Golden Valley, MN 55427
 * Currency: USD ($)
 */
...
const MENU_DATA = {
  ...
  categories: [
    { id: "all", name: "Most Popular", icon: "local_fire_department", count: 6 },
    { id: "milk-tea", name: "Milk Tea", icon: "local_cafe", count: 6 },
    { id: "fruit-tea", name: "Fruit Tea", icon: "eco", count: 5 },
    { id: "fresh-tea", name: "Fresh Tea", icon: "spa", count: 4 },
    { id: "energy", name: "Energy Series", icon: "bolt", count: 3 },
    { id: "no-caffeine", name: "No Caffeine", icon: "water_drop", count: 4 },
    { id: "desserts", name: "Desserts & Mochi", icon: "cake", count: 4 },
    { id: "snacks", name: "Asian Snacks", icon: "restaurant", count: 4 }
  ],
  ...
  // Store Locations in Minnesota
  stores: [
    {
      id: "golden-valley",
      name: "MiTea — Golden Valley (Flagship Store)",
      address: "7724 Olson Mem Hwy, Golden Valley, MN 55427",
    ...
    {
      id: "downtown-mpls",
      name: "MiTea — Downtown Minneapolis",
      address: "350 Nicollet Mall, Minneapolis, MN 55401",
      shortAddress: "350 Nicollet Mall",
      city: "Minneapolis",
      state: "MN",
      zip: "55401",
    ...
    {
      id: "st-paul-snelling",
      name: "MiTea — St. Paul / Grand Ave",
      address: "168 Snelling Ave N, St. Paul, MN 55104",
      shortAddress: "168 Snelling Ave N",
      city: "St. Paul",
      state: "MN",
      zip: "55104",
    ...
    {
      id: "uptown-mpls",
      name: "MiTea — Uptown Minneapolis",
      address: "1420 W Lake St, Minneapolis, MN 55408",
      shortAddress: "1420 W Lake St",
      city: "Minneapolis",
      state: "MN",
      zip: "55408",
...
// Autocomplete database for Golden Valley / Twin Cities Metro
const ADDRESS_DATABASE = [
  { full: "7724 Olson Mem Hwy, Golden Valley, MN 55427", street: "7724 Olson Mem Hwy", city: "Golden Valley, MN 55427", valid: true, estTime: "15–20 min", distance: "0.8 mi" },
  { full: "123 Main Street, Minneapolis, MN 55401", street: "123 Main Street", city: "Minneapolis, MN 55401", valid: true, estTime: "25–35 min", distance: "2.1 mi" },
  { full: "350 Nicollet Mall, Minneapolis, MN 55401", street: "350 Nicollet Mall", city: "Minneapolis, MN 55401", valid: true, estTime: "20–30 min", distance: "3.4 mi" },
  { full: "1420 W Lake St, Minneapolis, MN 55408", street: "1420 W Lake St", city: "Minneapolis, MN 55408", valid: true, estTime: "25–35 min", distance: "3.8 mi" },
  { full: "168 Snelling Ave N, St. Paul, MN 55104", street: "168 Snelling Ave N", city: "St. Paul, MN 55104", valid: true, estTime: "30–40 min", distance: "7.9 mi" },
  { full: "500 South 8th St, Minneapolis, MN 55404", street: "500 South 8th St", city: "Minneapolis, MN 55404", valid: true, estTime: "25–35 min", distance: "4.1 mi" },
  { full: "8401 Wayzata Blvd, Golden Valley, MN 55426", street: "8401 Wayzata Blvd", city: "Golden Valley, MN 55426", valid: true, estTime: "15–25 min", distance: "1.4 mi" },
  { full: "7000 York Ave S, Edina, MN 55435", street: "7000 York Ave S", city: "Edina, MN 55435", valid: true, estTime: "20–30 min", distance: "5.6 mi" },
  { full: "999 Faraway Country Road, Duluth, MN 55802", street: "999 Faraway Country Road", city: "Duluth, MN 55802", valid: false, reason: "out_of_zone", distance: "150 mi" }
];

if (typeof module !== "undefined" && module.exports) {
  module.exports = { MENU_DATA, ADDRESS_DATABASE };
}
